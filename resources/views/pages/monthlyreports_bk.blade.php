...
<!--div class="input-group date" id="datepick">
	...
	@foreach($dataarr as $data)
		...
		<td>{{$data->date}}</td>
                    <td>{{number_format($data->mr,2)}}</td>
                    <td>{{number_format($data->mr_disc,2)}}</td>
		    <td>{{number_format($data->mr_net,2)}}</td>
		<td>{{number_format($data->mr_contrast,2)}}</td>
		<td>{{number_format($data->mr_contrast_disc,2)}}</td>
		<td>{{number_format($data->mr_contrast_net,2)}}</td>
		<td>{{number_format(((float)$data->mr - (float)$data->mr_contrast),2)}}</td>
		<td>{{number_format(($data->mr_disc - $data->mr_contrast_disc),2)}}</td>
		<td>{{number_format(((float)$data->mr_net - (float)$data->mr_contrast_net),2)}}</td>
			<td>{{number_format($data->ct,2)}}</td>
                    <td>{{number_format($data->ct_disc,2)}}</td>
                    <td>{{number_format($data->ct_net,2)}}</td>
                <td>{{number_format($data->ct_contrast,2)}}</td>
                <td>{{number_format($data->ct_contrast_disc,2)}}</td>
		<td>{{number_format($data->ct_contrast_net,2)}}</td>
		<td>{{number_format(((float)$data->ct -(float) $data->ct_contrast),2)}}</td>
                <td>{{number_format(((float)$data->ct_disc - (float)$data->ct_contrast_disc),2)}}</td>
                <td>{{number_format(((float)$data->ct_net - (float)$data->ct_contrast_net),2)}}</td>
		 <td>{{number_format($data->totalgross,2)}}</td>
		<td>{{number_format($data->totaldiscount,2)}}</td>
		<td>{{number_format($data->totalnet,2)}}</td>
		  </tr>
		  @endforeach
		  <tfoot>
		  <tr>
