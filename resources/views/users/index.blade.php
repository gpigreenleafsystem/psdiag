    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
	      ...
	      <a class="btn btn-primary btn-round text-white pull-right" href="{{url('adduser')}}">Add user</a>		<!--<a class="btn btn-primary btn-round text-white pull-right" href="{{route('register')}}">Add user</a>--><div class="card-title">Users</h4>
